...
- `claude_cowork_generated/` — Cowork session artifacts including the compaction summary (`COMPACTION.md`) documenting the mid-session context recovery
...
- The primary transcript is `NYC Snow Analysis - Cowork Transcript.md` — it documents the full Cowork session workflow and task progression
- The `COMPACTION.md` file preserves context from before Cowork's mid-session compaction, including all qsv queries, error resolutions, and data gathered
